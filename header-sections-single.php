	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div id="header" class="section">
				...
				<div id="branding" class="section">
					...
					<?php if(in_category('blogs') || post_is_in_descendant_category(11)) { ?>
					<a href="/blogs">Blogs</a>
					<?php } else if(in_category('news') || post_is_in_descendant_category(3)) { ?>
					<a href="/news">News</a>
					<?php } else if(in_category('sports') || post_is_in_descendant_category(6)) { ?>
                                        <a href="/sports">Sports</a>
                                        <?php } else if(in_category('biz') || post_is_in_descendant_category(7)) { ?>
                                        <a href="/biz">Business</a>
                                        <?php } else if(in_category('opinion') || post_is_in_descendant_category(10)) { ?>
                                        <a href="/opinion">Opinion</a>
                                        <?php } else if(in_category('politics') || post_is_in_descendant_category(8)) { ?>
                                        <a href="/politics">Politics</a>
                                        <?php } else if(in_category('living') || post_is_in_descendant_category(15)) { ?>
                                        <a href="/living">Living</a>
					<?php } else if(in_category('a1')) { ?>
					<a href="/category/a1">A1</a>
					<?php } else if(in_category('abqnewsseeker')) { ?>
