...
* Code modified by Jolie McCullough to fit ABQJournal.com needs
*/
...
expstickybar.prototype={
	...
	showhide:function(keyword, anim){
		...
		var finalpx=(keyword=="show")? 0 : -313/*(this.height-this.setting.peekamount)*/
	...
	init:function($, setting){
		...
		//added code by JM to write cookie, so ad auto-expands only on first visit per browser session
		if( document.cookie.indexOf("footerad") < 0 )  {
        	        thisbar.toggle();
	                document.cookie = "footerad=hide";
        	}
	}
}
...
var mystickybar=new expstickybar({
	...
	externalcontent:'http://staging.abqjournal.com/wp-content/themes/dw-focus/footer-ad/stickybarcontent.htm', //path to sticky bar content file on your server, or "" if content is defined inline on the page
