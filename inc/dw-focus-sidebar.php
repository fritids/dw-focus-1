...
function dw_focus_widgets_init() {
    ...
    register_sidebar( array(
        'name' => __( 'Top Two - Main Sidebar', 'dw_focus' ),
        'id' => 'dw_focus_top_sidebar',
        'description'   =>  __('Use to display the first two widgets on the homepage','dw_focus'),
    ...
    register_sidebar( array(
        'name' => __( 'Bottom - Main Sidebar', 'dw_focus' ),
        'id' => 'dw_focus_sidebar',
        'description'   =>  __('Use to display all but first two widgets on the homepage','dw_focus'),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Top Home Content', 'dw_focus' ),
        'id' => 'dw_focus_top_home',
        'description'   =>  __('Use to display main stories on home','dw_focus'),
    ...
    register_sidebar( array(
        'name' => __( 'Top Sports Content', 'dw_focus' ),
        'id' => 'dw_focus_sports_content',
        'description'   =>  __('Use to display widget at top of sports', 'dw_focus'),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>',
